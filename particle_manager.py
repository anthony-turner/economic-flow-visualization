...
class UnrestParticle(Particle):
    def __init__(self, x: float, y: float, target_x: fFloat, target_y: float):
...
class EconomySimulation:
    ...
    def run(self):
        ...
        while running:
            ...
            mode_text = f"{STAGE_NAMES[self.stage]}"
            ...
            self.screen.blit(instruction_surface, (HEIGHT - 10, WIDTH - 300))
